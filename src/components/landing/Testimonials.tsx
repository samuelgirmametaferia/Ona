...
const testimonials = [
  {
    quote:
      "Stopped wasting 20 hours scraping. Had a list of 500 verified B2B contacts in 10 minutes.",
    author: "Sarah M.",
    role: "Marketing agency owner",
  },
  {
    quote:
      "One closed deal paid for LeadForge for the year. No-brainer for B2B outreach.",
    author: "James K.",
    role: "SaaS founder",
  },
  {
    quote:
      "Finally a database that's actually verified. Emails that bounce are rare.",
    author: "Alex T.",
    role: "Sales director",
  },
];
